...
const Home = () => {
    return (
        <div className='vw-100'>
            ...
            <Image className='my-5 vw-100' fluid src='https://img.freepik.com/free-vector/flat-business-employees-meeting-teamwork-training-teaching_88138-990.jpg'></Image>
            <p className='m-5 p-5'>
